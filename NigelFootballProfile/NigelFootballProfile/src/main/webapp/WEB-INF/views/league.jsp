		...
		<div class="row" id="top">
			<div class="col-lg-8">
				<h3>
					...
					<button type="button" class="btn btn-success" id="showStanding">
						<span class=" glyphicon glyphicon-list-alt"></span> Standing
					</button>
					<button type="button" class="btn btn-danger" id="showFixture">
						<span class=" glyphicon glyphicon-calendar"></span> Fixtures
					</button>
				</h3>
			</div>
		</div>
																			...
																			<div class="row">
																				<div class="col-md-12">
																					<form method="POST" role="form"
																						action="updateScore" id="frmUpdateScore">
